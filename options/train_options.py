...
class TrainOptions:
	...
	def initialize(self):
		self.parser.add_argument('--exp_dir', type=str, help='Path to experiment output directory', default="exp_debug")
		self.parser.add_argument('--dataset_type', default='fairface_super_resolution', type=str, help='Type of dataset/experiment to run')
		...
		self.parser.add_argument('--stylegan_weights', type=str, help='Path to StyleGAN model weights')
		...
		self.parser.add_argument('--fairness_k', default=0, type=int, help="Increase the weighting parameter for CE-loss and Classification-loss by fairness_m after each fairness_k steps.")
		self.parser.add_argument('--fairness_m', default=0., type=float, help="Increase the weighting parameter for CE-loss and Classification-loss by fairness_m after each fairness_k steps.")
		self.parser.add_argument('--train_labels_path', default="/USERSPACE/DATASETS/fairface/fairface_prop_celeba_label_train.csv", help="Path to csv storing the labels.")
		self.parser.add_argument('--test_labels_path', default="/USERSPACE/DATASETS/fairface/fairface_label_val.csv", help="Path to csv storing the labels.")
