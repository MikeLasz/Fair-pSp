...
DATASETS = {
	...
	'fairface_super_resolution': {
		'transforms': transforms_config.SuperResTransforms,
		'train_source_root': dataset_paths['fairface_train'],
		'train_target_root': dataset_paths['fairface_train'],
		'test_source_root': dataset_paths['fairface_test'],
		'test_target_root': dataset_paths['fairface_test'],
	},
	'fairface_prop_celeba_super_resolution': {
		'transforms': transforms_config.SuperResTransforms,
		'train_source_root': dataset_paths['fairface_train_prop_celeba'],
		'train_target_root': dataset_paths['fairface_train_prop_celeba'],
		'test_source_root': dataset_paths['fairface_test'],
		'test_target_root': dataset_paths['fairface_test'],
	},
